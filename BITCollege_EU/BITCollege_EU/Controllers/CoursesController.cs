...
namespace BITCollege_EU.Controllers
{
    public class CoursesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "CourdeId,AcademicProgramId,CourseNumber,Title,CreditHours,TuitionAmount,Notes")] Course course)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "CourdeId,AcademicProgramId,CourseNumber,Title,CreditHours,TuitionAmount,Notes")] Course course)
        {
            if (ModelState.IsValid)
            {
