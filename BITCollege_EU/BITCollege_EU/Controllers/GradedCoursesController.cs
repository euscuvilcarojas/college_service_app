...
namespace BITCollege_EU.Controllers
{
    public class GradedCoursesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "CourdeId,AcademicProgramId,CourseNumber,Title,CreditHours,TuitionAmount,Notes,AssignmentWeight,MidTermWeight,FinalWeight")] GradedCourse gradedCourse)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "CourdeId,AcademicProgramId,CourseNumber,Title,CreditHours,TuitionAmount,Notes,AssignmentWeight,MidTermWeight,FinalWeight")] GradedCourse gradedCourse)
        {
            if (ModelState.IsValid)
            {
